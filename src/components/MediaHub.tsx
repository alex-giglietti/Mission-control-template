...
const channelData: ChannelStats[] = [
  {
    ...
    color: "#FF0000",
    metrics: {
      today: { primary: { label: "SUBSCRIBERS", value: "124.5K" }, secondary: { label: "VIEWS", value: "12.4K" }, tertiary: { label: "WATCH HRS", value: "892" }, growth: 0.3 },
      "7d": { primary: { label: "SUBSCRIBERS", value: "124.5K" }, secondary: { label: "VIEWS", value: "89.2K" }, tertiary: { label: "WATCH HRS", value: "6.2K" }, growth: 2.1 },
      "30d": { primary: { label: "SUBSCRIBERS", value: "124.5K" }, secondary: { label: "VIEWS", value: "2.8M" }, tertiary: { label: "WATCH HRS", value: "45.2K" }, growth: 12.4 },
      "90d": { primary: { label: "SUBSCRIBERS", value: "124.5K" }, secondary: { label: "VIEWS", value: "8.4M" }, tertiary: { label: "WATCH HRS", value: "142K" }, growth: 28.7 },
      ytd: { primary: { label: "SUBSCRIBERS", value: "124.5K" }, secondary: { label: "VIEWS", value: "24.1M" }, tertiary: { label: "WATCH HRS", value: "389K" }, growth: 67.2 },
    },
  },
  {
    id: "instagram",
    ...
    color: "#E4405F",
    metrics: {
      today: { primary: { label: "FOLLOWERS", value: "89.2K" }, secondary: { label: "REACH", value: "8.4K" }, tertiary: { label: "ENGAGE %", value: "5.2%" }, growth: 0.2 },
      "7d": { primary: { label: "FOLLOWERS", value: "89.2K" }, secondary: { label: "REACH", value: "67.3K" }, tertiary: { label: "ENGAGE %", value: "4.9%" }, growth: 1.4 },
      "30d": { primary: { label: "FOLLOWERS", value: "89.2K" }, secondary: { label: "REACH", value: "1.2M" }, tertiary: { label: "ENGAGE %", value: "4.8%" }, growth: 8.7 },
      "90d": { primary: { label: "FOLLOWERS", value: "89.2K" }, secondary: { label: "REACH", value: "3.6M" }, tertiary: { label: "ENGAGE %", value: "4.6%" }, growth: 19.3 },
      ytd: { primary: { label: "FOLLOWERS", value: "89.2K" }, secondary: { label: "REACH", value: "9.8M" }, tertiary: { label: "ENGAGE %", value: "4.5%" }, growth: 42.1 },
    },
  },
  {
    id: "tiktok",
    ...
    color: "#00F2EA",
    metrics: {
      today: { primary: { label: "FOLLOWERS", value: "215K" }, secondary: { label: "VIEWS", value: "45.2K" }, tertiary: { label: "ENGAGE %", value: "6.8%" }, growth: 0.8 },
      "7d": { primary: { label: "FOLLOWERS", value: "215K" }, secondary: { label: "VIEWS", value: "312K" }, tertiary: { label: "ENGAGE %", value: "6.4%" }, growth: 4.2 },
      "30d": { primary: { label: "FOLLOWERS", value: "215K" }, secondary: { label: "VIEWS", value: "5.4M" }, tertiary: { label: "ENGAGE %", value: "6.2%" }, growth: 24.1 },
      "90d": { primary: { label: "FOLLOWERS", value: "215K" }, secondary: { label: "VIEWS", value: "16.2M" }, tertiary: { label: "ENGAGE %", value: "5.9%" }, growth: 58.4 },
      ytd: { primary: { label: "FOLLOWERS", value: "215K" }, secondary: { label: "VIEWS", value: "42.8M" }, tertiary: { label: "ENGAGE %", value: "5.7%" }, growth: 124.5 },
    },
  },
  {
    id: "linkedin",
    ...
    color: "#0A66C2",
    metrics: {
      today: { primary: { label: "FOLLOWERS", value: "45.8K" }, secondary: { label: "IMPRESSIONS", value: "4.2K" }, tertiary: { label: "ENGAGE %", value: "3.4%" }, growth: 0.1 },
      "7d": { primary: { label: "FOLLOWERS", value: "45.8K" }, secondary: { label: "IMPRESSIONS", value: "32.1K" }, tertiary: { label: "ENGAGE %", value: "3.3%" }, growth: 1.8 },
      "30d": { primary: { label: "FOLLOWERS", value: "45.8K" }, secondary: { label: "IMPRESSIONS", value: "890K" }, tertiary: { label: "ENGAGE %", value: "3.2%" }, growth: 15.3 },
      "90d": { primary: { label: "FOLLOWERS", value: "45.8K" }, secondary: { label: "IMPRESSIONS", value: "2.4M" }, tertiary: { label: "ENGAGE %", value: "3.1%" }, growth: 32.7 },
      ytd: { primary: { label: "FOLLOWERS", value: "45.8K" }, secondary: { label: "IMPRESSIONS", value: "6.2M" }, tertiary: { label: "ENGAGE %", value: "3.0%" }, growth: 56.8 },
    },
  },
  {
    id: "facebook",
    ...
    color: "#1877F2",
    metrics: {
      today: { primary: { label: "FOLLOWERS", value: "78.3K" }, secondary: { label: "REACH", value: "5.1K" }, tertiary: { label: "ENGAGE %", value: "2.9%" }, growth: 0.1 },
      "7d": { primary: { label: "FOLLOWERS", value: "78.3K" }, secondary: { label: "REACH", value: "42.3K" }, tertiary: { label: "ENGAGE %", value: "2.8%" }, growth: 0.8 },
      "30d": { primary: { label: "FOLLOWERS", value: "78.3K" }, secondary: { label: "REACH", value: "650K" }, tertiary: { label: "ENGAGE %", value: "2.9%" }, growth: 5.2 },
      "90d": { primary: { label: "FOLLOWERS", value: "78.3K" }, secondary: { label: "REACH", value: "1.8M" }, tertiary: { label: "ENGAGE %", value: "2.7%" }, growth: 11.4 },
      ytd: { primary: { label: "FOLLOWERS", value: "78.3K" }, secondary: { label: "REACH", value: "4.9M" }, tertiary: { label: "ENGAGE %", value: "2.6%" }, growth: 23.1 },
    },
  },
  {
    id: "twitter",
    ...
    color: "#000000",
    metrics: {
      today: { primary: { label: "FOLLOWERS", value: "34.1K" }, secondary: { label: "IMPRESSIONS", value: "8.9K" }, tertiary: { label: "ENGAGE %", value: "2.6%" }, growth: 0.2 },
      "7d": { primary: { label: "FOLLOWERS", value: "34.1K" }, secondary: { label: "IMPRESSIONS", value: "67.2K" }, tertiary: { label: "ENGAGE %", value: "2.5%" }, growth: 0.9 },
      "30d": { primary: { label: "FOLLOWERS", value: "34.1K" }, secondary: { label: "IMPRESSIONS", value: "1.1M" }, tertiary: { label: "ENGAGE %", value: "2.4%" }, growth: 3.8 },
      "90d": { primary: { label: "FOLLOWERS", value: "34.1K" }, secondary: { label: "IMPRESSIONS", value: "3.2M" }, tertiary: { label: "ENGAGE %", value: "2.3%" }, growth: 8.9 },
      ytd: { primary: { label: "FOLLOWERS", value: "34.1K" }, secondary: { label: "IMPRESSIONS", value: "8.7M" }, tertiary: { label: "ENGAGE %", value: "2.2%" }, growth: 18.4 },
    },
  },
  {
    id: "podcast",
